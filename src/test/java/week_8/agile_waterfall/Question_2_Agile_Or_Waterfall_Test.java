...
public class Question_2_Agile_Or_Waterfall_Test {
    ...
    public void testAgileWaterfallGUI() throws Exception {
        ...
        try {
            ...
            projectName = ReflectionUtils.getPrivateField(guiClass, "projectName");
        ...
        rec = getRecommendation(10, false, true, false, true, true, projectName);  // All for agile
        ...
        rec = getRecommendation(10, true, false, true, true, true, projectName);   // 3 for each
